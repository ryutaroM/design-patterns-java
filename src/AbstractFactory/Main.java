...
public class Main {
    public static void main(String[] args) {
        ...
        Link news2 = factory.createLink("News2", "https://example.com/news2");
        Tray news3 = factory.createTray("News3");
        news3.add(factory.createLink("News3-1", "https://example.com/news3-1"));
        news3.add(factory.createLink("News3-2", "https://example.com/news3-2"));
        ...
        // Page
        Page page = factory.createPage("Blog and News", "Rachel");
        page.add(blogTray);
        page.add(newsTray);
